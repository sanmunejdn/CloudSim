...
bool ingressUnifiedFromProgram(
...
bool egressUnifiedMergeIntoProgram(
	const UnifiedTrajectory& traj,
	RobotProgram& program,
	const std::string& pathPlanInstructionId,
	std::string* errMsg,
...
{
	return unifiedTrajectoryMergeIntoProgram(
		traj,
		program,
