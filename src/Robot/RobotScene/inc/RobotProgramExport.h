...
ROBOT_SCENE_API bool buildExportResult(
...
ROBOT_SCENE_API bool writeExportResultToJson(
	const RobotProgramExportResult& result,
	std::string& outJson,
	std::string* errMsg = nullptr);

ROBOT_SCENE_API bool writeExportResultToCsv(
	const RobotProgramExportResult& result,
	std::string& outCsv,
	std::string* errMsg = nullptr);
