...
ROBOT_SCENE_API BackendMat4 targetInBaseFromFlangeLinkWorld(const osg::Matrixd& T_base_flange_osg,
...
ROBOT_SCENE_API osg::Matrixd matrixOsgFromPoseMmDeg(double px, double py, double pz, double exDeg, double eyDeg,
													double ezDeg);
...
#endif // ROBOTSCENE_ROBOTMATRIXOSGBRIDGE_H
