#ifndef TRAJECTORYALGORITHMBUILTINS_DUPLICATEOP_H
#define TRAJECTORYALGORITHMBUILTINS_DUPLICATEOP_H

/// @file DuplicateOp.h
/// @brief DuplicateOp 接口
...
{
class DuplicateOp final : public ITrajectoryOp
{
public:
	RobotInstruction::TrajectoryOpKind kind() const override;
	const char* kindToken() const override { return "Duplicate"; }
...
#endif // TRAJECTORYALGORITHMBUILTINS_DUPLICATEOP_H
