#ifndef TRAJECTORYALGORITHMBUILTINS_RESAMPLEOP_H
#define TRAJECTORYALGORITHMBUILTINS_RESAMPLEOP_H
...
public:
	...
	const char* kindToken() const override { return "Resample"; }
...
#endif // TRAJECTORYALGORITHMBUILTINS_RESAMPLEOP_H
