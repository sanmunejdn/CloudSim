#ifndef TRAJECTORYALGORITHMBUILTINS_WEAVEOP_H
#define TRAJECTORYALGORITHMBUILTINS_WEAVEOP_H
...
{
class WeaveOp final : public ITrajectoryOp
{
public:
	RobotInstruction::TrajectoryOpKind kind() const override;
	const char* kindToken() const override { return "Weave"; }
...
#endif // TRAJECTORYALGORITHMBUILTINS_WEAVEOP_H
