#ifndef TRAJECTORYALGORITHMBUILTINS_ASSIGNSPEEDZONEOP_H
#define TRAJECTORYALGORITHMBUILTINS_ASSIGNSPEEDZONEOP_H

/// @file AssignSpeedZoneOp.h
/// @brief AssignSpeedZoneOp 接口
...
{
class AssignSpeedZoneOp final : public ITrajectoryOp
{
public:
	RobotInstruction::TrajectoryOpKind kind() const override;
	const char* kindToken() const override { return "AssignSpeedZone"; }
...
#endif // TRAJECTORYALGORITHMBUILTINS_ASSIGNSPEEDZONEOP_H
