#ifndef TRAJECTORYALGORITHMBUILTINS_PROJECTTOGEOMETRYOP_H
#define TRAJECTORYALGORITHMBUILTINS_PROJECTTOGEOMETRYOP_H

/// @file ProjectToGeometryOp.h
/// @brief ProjectToGeometryOp 接口
...
{
class ProjectToGeometryOp final : public ITrajectoryOp
{
public:
...
#endif // TRAJECTORYALGORITHMBUILTINS_PROJECTTOGEOMETRYOP_H
