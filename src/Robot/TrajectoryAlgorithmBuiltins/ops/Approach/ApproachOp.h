#ifndef TRAJECTORYALGORITHMBUILTINS_APPROACHOP_H
#define TRAJECTORYALGORITHMBUILTINS_APPROACHOP_H
...
{
class ApproachOp final : public ITrajectoryOp
{
public:
	RobotInstruction::TrajectoryOpKind kind() const override;
	const char* kindToken() const override { return "Approach"; }
...
#endif // TRAJECTORYALGORITHMBUILTINS_APPROACHOP_H
