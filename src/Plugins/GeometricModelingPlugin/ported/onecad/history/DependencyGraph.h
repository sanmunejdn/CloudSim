 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_DEPENDENCYGRAPH_H
#define GEOMETRICMODELINGPLUGIN_DEPENDENCYGRAPH_H
...
private:
     ...
     */
	void collectDownstream(const std::string& opId, std::unordered_set<std::string>& visited,
						   std::vector<std::string>& result) const;

	/**
     * @brief DFS helper for collecting upstream operations.
     */
	void collectUpstream(const std::string& opId, std::unordered_set<std::string>& visited,
						 std::vector<std::string>& result) const;
...
#endif // GEOMETRICMODELINGPLUGIN_DEPENDENCYGRAPH_H
