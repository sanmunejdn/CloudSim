...
SketchPoint::SketchPoint() : SketchEntity(), m_position(0.0, 0.0) {}

SketchPoint::SketchPoint(const gp_Pnt2d& position) : SketchEntity(), m_position(position) {}

SketchPoint::SketchPoint(double x, double y) : SketchEntity(), m_position(x, y) {}
