 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_SKETCHARC_H
#define GEOMETRICMODELINGPLUGIN_SKETCHARC_H
...
public:
     ...
     */
	SketchArc(const PointID& centerPointId, double radius, double startAngle, double endAngle);
	...
	bool isNearWithCenter(const gp_Pnt2d& testPoint, const gp_Pnt2d& centerPos, double tolerance) const;
     ...
     */
	void dragEndpoint(const gp_Pnt2d& centerPos, bool isDraggingStart, const gp_Pnt2d& newPos);
...
#endif // GEOMETRICMODELINGPLUGIN_SKETCHARC_H
