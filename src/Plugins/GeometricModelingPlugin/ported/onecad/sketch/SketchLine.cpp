...
SketchLine::SketchLine() : SketchEntity() {}

SketchLine::SketchLine(const PointID& startPointId, const PointID& endPointId)
	: SketchEntity(), m_startPointId(startPointId), m_endPointId(endPointId)
{
}
...
{
	return gp_Pnt2d((startPos.X() + endPos.X()) * 0.5, (startPos.Y() + endPos.Y()) * 0.5);
}
...
bool SketchLine::isHorizontal(const gp_Pnt2d& startPos, const gp_Pnt2d& endPos, double tolerance)
{
...
bool SketchLine::isVertical(const gp_Pnt2d& startPos, const gp_Pnt2d& endPos, double tolerance)
{
	double ang = angle(startPos, endPos);
...
double SketchLine::distanceToPoint(const gp_Pnt2d& point, const gp_Pnt2d& startPos, const gp_Pnt2d& endPos)
{
...
bool SketchLine::isNearWithPoints(const gp_Pnt2d& testPoint, const gp_Pnt2d& startPos, const gp_Pnt2d& endPos,
								  double tolerance)
{
