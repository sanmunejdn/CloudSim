 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_SKETCHPOINT_H
#define GEOMETRICMODELINGPLUGIN_SKETCHPOINT_H
...
public:
     ...
     */
	bool coincidentWith(const SketchPoint& other, double tolerance = constants::COINCIDENCE_TOLERANCE) const;
...
#endif // GEOMETRICMODELINGPLUGIN_SKETCHPOINT_H
