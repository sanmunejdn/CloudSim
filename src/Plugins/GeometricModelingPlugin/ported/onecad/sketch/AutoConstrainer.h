 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_AUTOCONSTRAINER_H
#define GEOMETRICMODELINGPLUGIN_AUTOCONSTRAINER_H
...
struct InferredConstraint
{
	...
	{
		return type == other.type && entity1 == other.entity1 && entity2 == other.entity2;
	}
};
...
public:
     ...
     */
	std::vector<InferredConstraint> inferConstraints(const Vec2d& point, const Sketch& sketch,
     ...
     */
	std::vector<InferredConstraint> inferLineConstraints(const Vec2d& startPoint, const Vec2d& endPoint,
     ...
     * @return Vector of inferred constraints
     */
	std::vector<InferredConstraint> inferCircleConstraints(const Vec2d& center, double radius, EntityID circleId,
														   const Sketch& sketch, const DrawingContext& context) const;
     ...
     * @return Vector of inferred constraints
     */
	std::vector<InferredConstraint> inferArcConstraints(const Vec2d& center, double radius, double startAngle,
														double endAngle, EntityID arcId, const Sketch& sketch,
														const DrawingContext& context) const;
     ...
     */
	std::vector<InferredConstraint> filterForAutoApply(const std::vector<InferredConstraint>& constraints) const;
...
private:
     ...
     */
	std::optional<InferredConstraint> inferHorizontal(const Vec2d& startPoint, const Vec2d& endPoint,
     ...
     */
	std::optional<InferredConstraint> inferVertical(const Vec2d& startPoint, const Vec2d& endPoint,
													EntityID lineId) const;
     ...
     */
	std::optional<InferredConstraint> inferCoincident(const Vec2d& point, const Sketch& sketch,
     ...
     */
	std::optional<InferredConstraint> inferPerpendicular(const Vec2d& line1Start, const Vec2d& line1End,
     ...
     */
	std::optional<InferredConstraint> inferParallel(const Vec2d& lineStart, const Vec2d& lineEnd, EntityID lineId,
													const Sketch& sketch, const DrawingContext& context) const;
     ...
     */
	std::optional<InferredConstraint> inferTangent(const Vec2d& arcCenter, const Vec2d& arcStartPoint, EntityID arcId,
												   const Sketch& sketch, const DrawingContext& context) const;
     ...
     */
	std::optional<InferredConstraint> inferConcentric(const Vec2d& center, EntityID entityId,
     ...
     */
	std::optional<InferredConstraint> inferEqualRadius(double radius, EntityID entityId, const Sketch& sketch) const;
     ...
     */
	static double angleBetweenLines(const Vec2d& line1Start, const Vec2d& line1End, const Vec2d& line2Start,
									const Vec2d& line2End);

	/**
     * @brief Check if two lines are approximately perpendicular
     */
	bool areLinesPerpendicular(const Vec2d& line1Start, const Vec2d& line1End, const Vec2d& line2Start,
							   const Vec2d& line2End) const;

	/**
     * @brief Check if two lines are approximately parallel
     */
	bool areLinesParallel(const Vec2d& line1Start, const Vec2d& line1End, const Vec2d& line2Start,
						  const Vec2d& line2End) const;
...
#endif // GEOMETRICMODELINGPLUGIN_AUTOCONSTRAINER_H
