...
SketchCircle::SketchCircle() : SketchEntity() {}
...
bool SketchCircle::isNearWithCenter(const gp_Pnt2d& testPoint, const gp_Pnt2d& centerPos, double tolerance) const
{
