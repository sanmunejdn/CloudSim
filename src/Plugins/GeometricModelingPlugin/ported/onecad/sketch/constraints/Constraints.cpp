...
double parallelAngleError(const gp_Pnt2d& s1, const gp_Pnt2d& e1, const gp_Pnt2d& s2, const gp_Pnt2d& e2)
{
...
double perpendicularAngleError(const gp_Pnt2d& s1, const gp_Pnt2d& e1, const gp_Pnt2d& s2, const gp_Pnt2d& e2)
{
	double a1 = SketchLine::angle(s1, e1);
	double a2 = SketchLine::angle(s2, e2);
	double diff = std::abs(normalizeAngle(a2 - a1));
...
gp_Pnt2d reflectPointAcrossLine(const gp_Pnt2d& point, const gp_Pnt2d& a, const gp_Pnt2d& b)
{
	...
	return gp_Pnt2d(2.0 * projection.X() - point.X(), 2.0 * projection.Y() - point.Y());
}
...
FixedConstraint::FixedConstraint(const PointID& pointId, double x, double y)
	: SketchConstraint(), m_pointId(pointId), m_fixedX(x), m_fixedY(y)
{
}
...
MidpointConstraint::MidpointConstraint(const PointID& pointId, const EntityID& lineId)
	: SketchConstraint(), m_pointId(pointId), m_lineId(lineId)
{
}
...
CoincidentConstraint::CoincidentConstraint(const PointID& point1, const PointID& point2)
	: SketchConstraint(), m_point1(point1), m_point2(point2)
{
}
...
HorizontalConstraint::HorizontalConstraint(const EntityID& lineId) : SketchConstraint(), m_lineId(lineId) {}
...
VerticalConstraint::VerticalConstraint(const EntityID& lineId) : SketchConstraint(), m_lineId(lineId) {}
...
ParallelConstraint::ParallelConstraint(const EntityID& line1, const EntityID& line2)
	: SketchConstraint(), m_line1(line1), m_line2(line2)
{
}
...
TangentConstraint::TangentConstraint(const EntityID& entity1, const EntityID& entity2)
	: SketchConstraint(), m_entity1(entity1), m_entity2(entity2)
{
}
...
DistanceConstraint::DistanceConstraint(const EntityID& entity1, const EntityID& entity2, double distance)
	: DimensionalConstraint(distance), m_entity1(entity1), m_entity2(entity2)
{
}
...
HorizontalDistanceConstraint::HorizontalDistanceConstraint(const EntityID& point1, const EntityID& point2,
														   double distance)
	: DimensionalConstraint(distance), m_point1(point1), m_point2(point2)
{
}
...
VerticalDistanceConstraint::VerticalDistanceConstraint(const EntityID& point1, const EntityID& point2, double distance)
	: DimensionalConstraint(distance), m_point1(point1), m_point2(point2)
{
}
...
AngleConstraint::AngleConstraint(const EntityID& line1, const EntityID& line2, double angleRadians)
	: DimensionalConstraint(angleRadians), m_line1(line1), m_line2(line2)
{
}
...
RadiusConstraint::RadiusConstraint(const EntityID& circleOrArc, double radius)
	: DimensionalConstraint(radius), m_entityId(circleOrArc)
{
}
...
DiameterConstraint::DiameterConstraint(const EntityID& circleOrArc, double diameter)
	: DimensionalConstraint(diameter), m_entityId(circleOrArc)
{
}
...
SymmetricConstraint::SymmetricConstraint(const EntityID& point1, const EntityID& point2, const EntityID& axisLine)
	: m_point1(point1), m_point2(point2), m_axisLine(axisLine)
{
}
...
PointOnCurveConstraint::PointOnCurveConstraint(const EntityID& pointId, const EntityID& curveId, CurvePosition position)
...
double PointOnCurveConstraint::getError(const Sketch& sketch) const
{
	...
	case EntityType::Line:
	{
		...
		else
		{
			...
			gp_Pnt2d projection(lineStart.X() + t * lineVec.X(), lineStart.Y() + t * lineVec.Y());
