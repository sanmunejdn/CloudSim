...
namespace
{
bool computeBoundingCircle(const SketchEntity& entity, const Sketch& sketch, Vec2d& center, double& radius)
{
	switch (entity.type())
	{
...
SpatialHashGrid::SpatialHashGrid(double cellSize) : cellSize_(cellSize)
{
	if (cellSize_ <= 0.0)
	{
