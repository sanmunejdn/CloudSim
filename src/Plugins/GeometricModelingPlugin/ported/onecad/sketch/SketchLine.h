 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_SKETCHLINE_H
#define GEOMETRICMODELINGPLUGIN_SKETCHLINE_H
...
public:
     ...
     */
	static bool isHorizontal(const gp_Pnt2d& startPos, const gp_Pnt2d& endPos, double tolerance = 1e-6);
     ...
     */
	static bool isVertical(const gp_Pnt2d& startPos, const gp_Pnt2d& endPos, double tolerance = 1e-6);
     ...
     */
	static double distanceToPoint(const gp_Pnt2d& point, const gp_Pnt2d& startPos, const gp_Pnt2d& endPos);
     ...
     */
	static bool isNearWithPoints(const gp_Pnt2d& testPoint, const gp_Pnt2d& startPos, const gp_Pnt2d& endPos,
								 double tolerance);
...
#endif // GEOMETRICMODELINGPLUGIN_SKETCHLINE_H
