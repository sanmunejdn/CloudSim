 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_SKETCHELLIPSE_H
#define GEOMETRICMODELINGPLUGIN_SKETCHELLIPSE_H
...
public:
     ...
     */
	SketchEllipse(const PointID& centerPointId, double majorRadius, double minorRadius, double rotation = 0.0);
...
#endif // GEOMETRICMODELINGPLUGIN_SKETCHELLIPSE_H
