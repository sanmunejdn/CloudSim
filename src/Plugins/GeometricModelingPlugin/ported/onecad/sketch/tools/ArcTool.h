 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_ARCTOOL_H
#define GEOMETRICMODELINGPLUGIN_ARCTOOL_H
...
private:
     ...
     */
	bool calculateArcFromThreePoints(const Vec2d& p1, const Vec2d& p2, const Vec2d& p3, Vec2d& center, double& radius,
...
#endif // GEOMETRICMODELINGPLUGIN_ARCTOOL_H
