 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_SNAPPREVIEWRESOLVER_H
#define GEOMETRICMODELINGPLUGIN_SNAPPREVIEWRESOLVER_H
...
SnapInputResolution resolveSnapForInputEvent(const SnapManager& snapManager, const Vec2d& pos, const Sketch& sketch,
											 ...
											 bool preferGuide = false, bool collectGuideData = false);

} // namespace tools
} // namespace onecad::core::sketch

#endif // GEOMETRICMODELINGPLUGIN_SNAPPREVIEWRESOLVER_H
