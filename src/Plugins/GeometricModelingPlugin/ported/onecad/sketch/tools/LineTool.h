 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_LINETOOL_H
#define GEOMETRICMODELINGPLUGIN_LINETOOL_H
...
public:
	...
	PreviewDimensionApplyResult applyPreviewDimensionValue(const std::string& id, double value) override;
...
private:
     ...
     */
	void applyInferredConstraints(const std::vector<InferredConstraint>& constraints, EntityID lineId);
...
#endif // GEOMETRICMODELINGPLUGIN_LINETOOL_H
