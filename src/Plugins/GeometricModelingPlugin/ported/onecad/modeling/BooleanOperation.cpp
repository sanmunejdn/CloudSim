/// @file BooleanOperation.cpp
/// @brief BooleanOperation 实现
...
{
TopoDS_Shape BooleanOperation::perform(const TopoDS_Shape& tool, const TopoDS_Shape& target, app::BooleanMode mode)
{
...
app::BooleanMode BooleanOperation::detectMode(const TopoDS_Shape& tool, const std::vector<TopoDS_Shape>& targets,
