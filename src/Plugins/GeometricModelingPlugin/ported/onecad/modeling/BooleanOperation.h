#ifndef GEOMETRICMODELINGPLUGIN_BOOLEANOPERATION_H
#define GEOMETRICMODELINGPLUGIN_BOOLEANOPERATION_H

/// @file BooleanOperation.h
/// @brief BooleanOperation 接口
...
public:
     ...
     */
	static TopoDS_Shape perform(const TopoDS_Shape& tool, const TopoDS_Shape& target, app::BooleanMode mode);
     ...
     */
	static app::BooleanMode detectMode(const TopoDS_Shape& tool, const std::vector<TopoDS_Shape>& targets,
									   const gp_Pnt& probeStart, const gp_Vec& probeStep);
...
#endif // GEOMETRICMODELINGPLUGIN_BOOLEANOPERATION_H
