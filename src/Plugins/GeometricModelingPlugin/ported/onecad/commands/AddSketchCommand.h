 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_ADDSKETCHCOMMAND_H
#define GEOMETRICMODELINGPLUGIN_ADDSKETCHCOMMAND_H
...
{
public:
	AddSketchCommand(Document* document, const core::sketch::SketchPlane& plane, std::string name = {});
...
#endif // GEOMETRICMODELINGPLUGIN_ADDSKETCHCOMMAND_H
