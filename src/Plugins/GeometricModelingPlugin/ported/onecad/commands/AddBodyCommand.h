 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_ADDBODYCOMMAND_H
#define GEOMETRICMODELINGPLUGIN_ADDBODYCOMMAND_H
...
{
public:
	AddBodyCommand(Document* document, const TopoDS_Shape& shape, const std::string& bodyId = {},
...
#endif // GEOMETRICMODELINGPLUGIN_ADDBODYCOMMAND_H
