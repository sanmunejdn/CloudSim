/// @file ModifyBodyCommand.cpp
/// @brief ModifyBodyCommand 实现
...
{
ModifyBodyCommand::ModifyBodyCommand(Document* document, const std::string& bodyId, const TopoDS_Shape& newShape)
