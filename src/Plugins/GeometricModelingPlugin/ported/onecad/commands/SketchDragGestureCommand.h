#ifndef GEOMETRICMODELINGPLUGIN_SKETCHDRAGGESTURECOMMAND_H
#define GEOMETRICMODELINGPLUGIN_SKETCHDRAGGESTURECOMMAND_H

/// @file SketchDragGestureCommand.h
/// @brief SketchDragGestureCommand 接口
...
{
public:
	SketchDragGestureCommand(Document* document, std::string sketchId, std::string label = "Sketch Drag Gesture");
...
private:
	bool snapshotSketchState(std::string* outJson, std::string* outName, bool* outVisible) const;
	bool restoreSketchState(const std::string& json, const std::string& name, bool visible);
...
#endif // GEOMETRICMODELINGPLUGIN_SKETCHDRAGGESTURECOMMAND_H
