...
{
AddBodyCommand::AddBodyCommand(Document* document, const TopoDS_Shape& shape, const std::string& bodyId,
							   const std::string& bodyName)
	: document_(document), shape_(shape), bodyId_(bodyId), bodyName_(bodyName)
{
}
