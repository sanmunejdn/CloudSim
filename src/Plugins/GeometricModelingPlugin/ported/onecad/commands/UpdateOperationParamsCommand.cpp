...
{
UpdateOperationParamsCommand::UpdateOperationParamsCommand(Document* document, std::string opId, OperationParams params)
	: document_(document), opId_(std::move(opId)), newParams_(std::move(params))
{
}
