...
{
AddSketchCommand::AddSketchCommand(Document* document, const core::sketch::SketchPlane& plane, std::string name)
	: document_(document), plane_(plane), name_(std::move(name)),
