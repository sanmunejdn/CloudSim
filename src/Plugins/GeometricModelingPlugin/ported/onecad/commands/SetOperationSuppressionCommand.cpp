...
{
SetOperationSuppressionCommand::SetOperationSuppressionCommand(Document* document, std::string opId, bool suppressed)
	: document_(document), opId_(std::move(opId)), newSuppressed_(suppressed)
{
}
