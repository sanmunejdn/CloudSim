 ...
 */
#ifndef GEOMETRICMODELINGPLUGIN_DELETESKETCHCOMMAND_H
#define GEOMETRICMODELINGPLUGIN_DELETESKETCHCOMMAND_H
...
#endif // GEOMETRICMODELINGPLUGIN_DELETESKETCHCOMMAND_H
