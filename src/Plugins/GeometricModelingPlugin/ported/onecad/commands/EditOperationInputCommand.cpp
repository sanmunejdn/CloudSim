...
{
EditOperationInputCommand::EditOperationInputCommand(Document* document, std::string opId, OperationInput newInput)
	: document_(document), opId_(std::move(opId)), newInput_(std::move(newInput))
{
}
