...
void System::setConvergence(double tol)
{
    if (tol > 0.0) {
        convergence = tol;
    }
...
void System::setMaxIterations(int maxIterIn)
{
    if (maxIterIn > 0) {
        maxIter = maxIterIn;
    }
...
void System::setConvergenceRedundant(double tol)
{
    if (tol > 0.0) {
        convergenceRedundant = tol;
    }
}

void System::setMaxIterationsRedundant(int maxIterIn)
{
    if (maxIterIn > 0) {
        maxIterRedundant = maxIterIn;
    }
}
