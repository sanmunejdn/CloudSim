...
PlcCommController::PlcCommController(QObject* parent)
    : QObject(parent)
{
...
void PlcCommController::setUseChinese(bool chinese)
{
    ...
    QMetaObject::invokeMethod(worker_, "setUseChinese", Qt::QueuedConnection,
        Q_ARG(bool, chinese));
}
...
{
    QMetaObject::invokeMethod(worker_, "connectPlc", Qt::QueuedConnection,
        Q_ARG(PlcConnectionConfig, config));
}
...
{
    QMetaObject::invokeMethod(worker_, "addTag", Qt::QueuedConnection,
        Q_ARG(PlcTagSpec, spec));
}

void PlcCommController::removeTag(int handle)
{
    QMetaObject::invokeMethod(worker_, "removeTag", Qt::QueuedConnection,
        Q_ARG(int, handle));
}

void PlcCommController::readTag(int handle)
{
    QMetaObject::invokeMethod(worker_, "readTag", Qt::QueuedConnection,
        Q_ARG(int, handle));
}

void PlcCommController::writeTag(int handle, const QByteArray& data)
{
    QMetaObject::invokeMethod(worker_, "writeTag", Qt::QueuedConnection,
        Q_ARG(int, handle), Q_ARG(QByteArray, data));
}

void PlcCommController::pollTags(const QList<int>& handles)
{
    QMetaObject::invokeMethod(worker_, "pollTags", Qt::QueuedConnection,
        Q_ARG(QList<int>, handles));
}
