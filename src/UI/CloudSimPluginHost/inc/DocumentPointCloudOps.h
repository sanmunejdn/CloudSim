...
std::string registerReconstructedMesh(cloudsim::host::DocumentHost* page, IPluginMainWindowHost* mainWindowHost,
									  ...
									  const PluginMeshCreateOptions& options, std::string* outError = nullptr);
...
CLOUDSIM_HOST_EXPORT bool exportPointCloudToPly(cloudsim::host::DocumentHost* page, const std::string& backendIdUtf8,
												const std::string& pathUtf8, std::string* outError = nullptr);

CLOUDSIM_HOST_EXPORT bool exportBrepToStep(cloudsim::host::DocumentHost* page, const std::string& backendIdUtf8,
										   const std::string& pathUtf8, std::string* outError = nullptr);
...
void logRegistrationCentroidDiagnostic(cloudsim::host::DocumentHost* page, const std::string& scanBackendIdUtf8,
									   ...
									   const std::vector<float>& scanStoredXyz, double templateModelCenterX,
									   double templateModelCenterY, double templateModelCenterZ);

bool queryTemplateModelToWorldIsometry(cloudsim::host::DocumentHost* page, const std::string& templateBackendIdUtf8,
									   Eigen::Isometry3d& outModelToWorld, std::string* outError = nullptr);

bool queryScanStoredToWorldIsometry(cloudsim::host::DocumentHost* page, const std::string& scanBackendIdUtf8,
									Eigen::Isometry3d& outStoredToWorld, std::string* outError = nullptr);
...
bool applyTemplateRegistrationToVisual(cloudsim::host::DocumentHost* page, const std::string& templateBackendIdUtf8,
									   const Eigen::Isometry3d& icpDeltaWorld, std::string* outError = nullptr);
...
bool restoreTemplateShapeFromStep(cloudsim::host::DocumentHost* page, const std::string& templateBackendIdUtf8,
								  const std::string& templateStepPathUtf8, std::string* outError = nullptr);
...
bool prepareScanForTemplateRegistration(cloudsim::host::DocumentHost* page, const std::string& scanBackendIdUtf8,
										...
										std::size_t& outPointCount, bool& outIsMeshScan,
										std::string* outError = nullptr);
...
#endif // CLOUDSIMPLUGINHOST_DOCUMENTPOINTCLOUDOPS_H
