...
public:
	...
	virtual void appendPropertyBrowserRow(const QString& propertyKey, const QString& displayLabel, const QString& value,
	...
	virtual RobotInstruction::FeasibleMotionAxisConfigurationOptions
