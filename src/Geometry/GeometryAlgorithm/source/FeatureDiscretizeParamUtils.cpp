...
FeatureDiscretizerParamField doubleFeatureParamField(
	const std::string& key,
...
FeatureDiscretizerParamField intFeatureParamField(
	const std::string& key,
	const std::string& labelEn,
	const std::string& labelZh,
	const int minValue,
...
FeatureDiscretizerParamField boolFeatureParamField(
	const std::string& key,
	const std::string& labelEn,
	const std::string& labelZh,
...
FeatureDiscretizerParamField enumFeatureParamField(
	const std::string& key,
	const std::string& labelEn,
	const std::string& labelZh,
