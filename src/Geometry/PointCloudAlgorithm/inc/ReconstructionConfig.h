...
// 新增配置版本API
POINT_CLOUD_ALGORITHM_API bool reconstructPoissonWithConfig(
...
POINT_CLOUD_ALGORITHM_API bool reconstructPoissonAutoWithConfig(
    std::vector<float> xyz,
    std::vector<float>& triangleSoupOut,
    const ReconstructionConfig& config,
    std::string* errMsg = nullptr);

POINT_CLOUD_ALGORITHM_API bool reconstructScaleSpaceWithConfig(
    std::vector<float> xyz,
    std::vector<float>& triangleSoupOut,
    const ReconstructionConfig& config,
    std::string* errMsg = nullptr);
