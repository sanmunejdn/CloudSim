...
POINT_CLOUD_ALGORITHM_API bool rigidRegisterIcp(
	...
	const std::vector<float>* sourceNormalsNxNyNz = nullptr,
	const std::vector<float>* targetNormalsNxNyNz = nullptr,
	double maxNormalAngleDeg = 0.0);

POINT_CLOUD_ALGORITHM_API bool rigidRegisterPointToPlaneIcp(
	const std::vector<float>& sourceXyz,
