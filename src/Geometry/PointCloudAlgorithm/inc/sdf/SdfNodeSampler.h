#ifndef POINTCLOUDALGORITHM_SDFNODESAMPLER_H
#define POINTCLOUDALGORITHM_SDFNODESAMPLER_H
...
bool buildDeformGraph(const std::vector<float>& xyz, double sampleRadiusMm, int kSkin, int kNodeNeighbors,
					  DeformGraph& out, std::string* errMsg, const std::vector<std::vector<int>>* vertAdj = nullptr);

} // namespace sdf
} // namespace pclalgo

#endif // POINTCLOUDALGORITHM_SDFNODESAMPLER_H
