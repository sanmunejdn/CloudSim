#ifndef VCGALGORITHMS_VCGMESHTYPES_H
#define VCGALGORITHMS_VCGMESHTYPES_H

/// @file VcgMeshTypes.h
/// @brief VcgMeshTypes 接口
...
class VcgVertex
	: public vcg::Vertex<VcgUsedTypes, vcg::vertex::VFAdj, vcg::vertex::Coord3d, vcg::vertex::Normal3d,
						 vcg::vertex::Mark, vcg::vertex::Qualityd, vcg::vertex::CurvatureDird, vcg::vertex::BitFlags>
{
public:
...
class VcgFace : public vcg::Face<VcgUsedTypes, vcg::face::Mark, vcg::face::VFAdj, vcg::face::FFAdj,
								 vcg::face::VertexRef, vcg::face::Normal3d, vcg::face::Qualityd, vcg::face::BitFlags>
{
};
...
using VcgMesh = vcg::tri::TriMesh<std::vector<VcgVertex>, std::vector<VcgFace>, std::vector<VcgEdge>>;
...
#endif // VCGALGORITHMS_VCGMESHTYPES_H
