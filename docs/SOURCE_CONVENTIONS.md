...
> **权威约定**（2026-07 起）。与 `.cursor/rules/cloudsim-cpp-conventions.mdc`、[`MODULE_DEVELOPER_GUIDES.md`](MODULE_DEVELOPER_GUIDES.md) 保持一致。验收记录见 [`_archive/code_format_cleanup/ACCEPTANCE_code_format_cleanup.md`](../../ARCHIVE_ZIP_LOCATION.txt) <!-- was _archive/code_format_cleanup/ACCEPTANCE_code_format_cleanup.md)。
